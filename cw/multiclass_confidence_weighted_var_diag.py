...
class MCWVarDiag(object):
    ...
    def __init__(self, fname, delimiter = " ", eta = 0.9, n_scan = 10):
        """
    ...
    @classmethod
    def examplify(cls, fname, delimiter = " ", eta = 0.9, n_scan = 10):
        """
        Example of how to use
        """
        
        # learn
        model = MCWVarDiag(fname = fname, delimiter = delimiter, eta = eta, n_scan = n_scan)
        model.learn()
...
if __name__ == '__main__':
    ...
    MCWVarDiag.examplify(fname, delimiter = " ", eta = 0.9, n_scan = 10)
